...
use App\Middleware\CustomUpdateMiddleware;
...
use App\Middleware\StopTrafficBuyerMiddleware;
...
class Application extends BaseApplication
{
    ...
    public function middleware($middlewareQueue)
    {
        $middlewareQueue
            ...
            ->add(new StopTrafficBuyerMiddleware())
            ->add(new CustomUpdateMiddleware())
            // Add csrf middleware.
