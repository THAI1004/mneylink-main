                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12" style="margin-bottom: 15px">
                                        ...
                                        <input type="text" name="packages[<?=$k?>][name]" class="form-control package-name" required value="<?=$package->name?>">
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="">Time</label>
                                        <input type="number" name="packages[<?=$k?>][time]" class="form-control" required value="<?=$package->time?>">
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="">Số tiền/view</label>
                                        <input type="number" name="packages[<?=$k?>][price]" class="form-control" required value="<?=$package->price?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel panel-default item" data-number="__number__">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12" style="margin-bottom: 15px">
                                <label for="">Tiêu đề</label>
                                <input type="text" __name__="packages[__number__][name]" class="form-control package-name" required>
                            </div>
                            <div class="col-lg-6">
                                <label for="">Time</label>
                                <input type="number" __name__="packages[__number__][time]" class="form-control" required>
                            </div>
                            <div class="col-lg-6">
                                <label for="">Số tiền/view</label>
                                <input type="number" __name__="packages[__number__][price]" class="form-control" required>
                            </div>
                        </div>
                    </div>
                </div>
