    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'dashboard']); ?>">
                        <i class="fa fa-dashboard"></i> <span><?= __('Statistics') ?></span></a></li>
                <li class="treeview">
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-globe"></i> <span><?= __('Traffics') ?></span> <i
                            class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                    ...
                    <?php if (get_option('earning_mode', 'campaign') === 'simple') : ?>
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo $this->Url->build([
                                        'controller' => 'Traffics2',
                                        'action' => 'payoutBanner',
                                        'prefix' => 'admin',
                                    ]); ?>"><?= __('Banner Traffics2') ?></a></li>
                                <li><a href="<?php echo $this->Url->build([
                                        'controller' => 'Options',
                                        'action' => 'payoutPopup',
                                        'prefix' => 'admin',
                ...
                <?php if (in_array($user['role'], is_admin_camp())): ?>
                    <li class="treeview">
                        <a href="<?php echo $this->Url->build(['controller' => 'Reports', 'action' => 'campaigns']); ?>">
                            <i class="fa fa-pie-chart"></i> <span><?= __('Reports') ?> <span class="notification"><?=request_count('total')?></span></span>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if (in_array($user['role'], is_admin_camp())): ?>
                                <li><a href="<?php echo $this->Url->build([
                                        'controller' => 'BuyerReports',
                                        'action' => 'index',
                                    ]); ?>"><?= __('Buyer Report') ?>
                                        <span class="notification"><?=request_count('buyer')?></span>
                                    </a></li>
                            <?php endif; ?>
                            <?php if (in_array($user['role'], is_admin())): ?>
                                <li><a href="<?php echo $this->Url->build([
                                        'controller' => 'MemberReports',
                                        'action' => 'index',
                                    ]); ?>"><?= __('Member Report') ?>
                                        <span class="notification"><?=request_count('member')?></span>
                                    </a></li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if (in_array($user['role'], is_admin())): ?>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-bars"></i> <span><?= __('Plans') ?></span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="<?php echo $this->Url->build([
