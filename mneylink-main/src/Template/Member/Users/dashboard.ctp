...
?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-xs-12">
            <!-- small box -->
            <div class="small-box bg-olive text-center">
                <div class="inner">
                    <h3><?=number_format($traffics_statics['count_day'] - $traffics_statics['date'])?></h3>
                    <p><?= __('Số view còn lại của hệ thống trong ngày') ?></p>
                </div>
                <div class="icon">
