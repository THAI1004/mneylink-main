...
<nav id="mainNav" class="navbar navbar-default">
    ...
    <!-- /.container-fluid -->
    <h2 style="text-align:center; font-size: 40px; color: #fff; margin-top: 40px; margin-bottom: 40px;line-height: 60px;"><span style="">TIẾP TỤC ĐỂ TẢI FILE / TRUY CẬP LINK ĐÍCH</span></h2>
</nav>
