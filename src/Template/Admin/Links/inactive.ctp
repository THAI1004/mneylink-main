...
<div class="box box-solid">
    <div class="box-body">
        ...
        echo $this->Form->create(null, [
            'url' => $base_url,
            'class' => 'form-inline d-flex gap-1 justify-content-start align-items-center',
        ]);
        ?>
        ...
        <?= $this->Form->button(__('Filter'), ['class' => 'btn btn-primary btn-sm']); ?>

        <?= $this->Html->link(__('Reset'), $base_url, ['class' => 'btn btn-warning btn-sm']); ?>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-hover table-striped">
                <tr>
                    ...
                    <th>
                        <div class="form-inline d-flex gap-1 justify-content-start align-items-center">
                            <?=
