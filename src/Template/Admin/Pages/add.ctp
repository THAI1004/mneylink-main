    ...
    <div class="row justify-content-center">
        <div class="col-xl-10">
            <div class="card shadow-lg border-0 rounded-lg">
                <div class="card-header page-header-gradient text-white text-center py-4">
                    <div class="mb-2">
                        <i class="fa fa-file-text-o fa-3x opacity-75"></i>
                    </div>
                    <h3 class="mb-0 fw-bold"><?= __('Create New Page') ?></h3>
                    <p class="mb-0 mt-2 opacity-75"><?= __('Build custom pages for your website') ?></p>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold text-white mb-3">
                            <i class="fa fa-info-circle me-2"></i><?= __('Page Information') ?>
                        </h5>
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold text-white mb-3">
                            <i class="fa fa-edit me-2"></i><?= __('Page Content') ?>
                        </h5>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text text-white">
                                <i class="fa fa-info-circle me-1"></i>
                                <?= __('Use the editor to create rich content with formatting, images, and links') ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold text-white mb-3">
                            <i class="fa-solid fa-magnifying-glass"></i><?= __('SEO Settings') ?>
                        </h5>
                        ...
                        <div class="alert text-white alert-info d-flex align-items-start mb-3" role="alert">
                            ...
                            <div class="small">
                                ...
                                <?= __('Well-optimized meta tags improve your page\'s visibility in search engine results.') ?>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 pt-4 border-top">
                        ...
                        <?= $this->Form->button(
                            '<i class="fa fa-check me-2"></i>' . __('Create Page'),
