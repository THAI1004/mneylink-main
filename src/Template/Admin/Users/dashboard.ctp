...
<div class="row">
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            <div class="inner text-center bg-primary rounded ">
    ...
    <div class="col-lg-3 col-xs-6">
        <!-- small box -->
        <div class="small-box bg-aqua">
            <div class="inner  text-center bg-warning rounded ">
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
            <div class="inner text-center bg-success rounded ">
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-yellow">
            <div class="inner text-center bg-info rounded ">
                <h3><?= $total_views ?></h3>
