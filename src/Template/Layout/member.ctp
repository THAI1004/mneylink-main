...
<body class="bg-theme bg-theme2">
    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="<?= $this->Url->build(['controller' => 'Links', 'action' => 'index', 'prefix' => 'member']); ?>">
                                <i class='bx bx-radio-circle'></i><?= __('All Links') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= $this->Url->build(['controller' => 'Links', 'action' => 'hidden', 'prefix' => 'member']); ?>">
                                <i class='bx bx-radio-circle'></i><?= __('Hidden Links') ?>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="<?= $this->Url->build(['controller' => 'Withdraws', 'action' => 'index', 'prefix' => 'member']); ?>">
                        <div class="parent-icon"><i class='bx bx-dollar'></i></div>
                        <div class="menu-title"><?= __('Withdraw') ?></div>
                    </a>
                </li>
                ...
                <?php if (
                    ...
                    <li>
                        <a href="javascript:;" class="has-arrow">
                            ...
                            <div class="menu-title"><?= __('Tools') ?></div>
                        </a>
                        <ul>
                            <?php if ($logged_user_plan->api_quick) : ?>
                                <li>
                                    <a href="<?= $this->Url->build(['controller' => 'Tools', 'action' => 'quick', 'prefix' => 'member']); ?>">
                                        <i class='bx bx-radio-circle'></i><?= __('Quick Link') ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                            <?php if ($logged_user_plan->api_mass) : ?>
                                <li>
                                    <a href="<?= $this->Url->build(['controller' => 'Tools', 'action' => 'massShrinker', 'prefix' => 'member']); ?>">
                                        <i class='bx bx-radio-circle'></i><?= __('Mass Shrinker') ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                            <?php if ($logged_user_plan->api_full) : ?>
                                <li>
                                    <a href="<?= $this->Url->build(['controller' => 'Tools', 'action' => 'full', 'prefix' => 'member']); ?>">
                                        <i class='bx bx-radio-circle'></i><?= __('Full Page Script') ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                            <?php if ($logged_user_plan->api_developer) : ?>
                                <li>
                                    <a href="<?= $this->Url->build(['controller' => 'Tools', 'action' => 'api', 'prefix' => 'member']); ?>">
                                        <i class='bx bx-radio-circle'></i><?= __('Developers API') ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                            <?php if ($logged_user_plan->bookmarklet) : ?>
                                <li>
                                    <a href="<?= $this->Url->build(['controller' => 'Tools', 'action' => 'bookmarklet', 'prefix' => 'member']); ?>">
                                        <i class='bx bx-radio-circle'></i><?= __('Bookmarklet') ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                        </ul>
                ...
                <?php if ((bool)get_option('enable_referrals', 1)) : ?>
                    <li>
                        <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'referrals', 'prefix' => 'member']); ?>">
                            <div class="parent-icon"><i class='bx bx-group'></i></div>
                            <div class="menu-title"><?= __('Referrals') ?></div>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if (
                    ...
                    <li>
                        <a href="javascript:;" class="has-arrow">
                            <div class="parent-icon"><i class='bx bx-paper-plane'></i></div>
                            <div class="menu-title"><?= __('Campaigns') ?></div>
                        </a>
                        <ul>
                            <li>
                                <a href="<?= $this->Url->build(['controller' => 'Campaigns', 'action' => 'index', 'prefix' => 'member']); ?>">
                                    <i class='bx bx-radio-circle'></i><?= __('List') ?>
                                </a>
                            </li>
                            <?php if (get_option('enable_interstitial', 'yes') == 'yes') : ?>
                                <li>
                                    <a href="<?= $this->Url->build(['controller' => 'Campaigns', 'action' => 'createInterstitial', 'prefix' => 'member']); ?>">
                                        <i class='bx bx-radio-circle'></i><?= __('Create Interstitial Campaign') ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                            <?php if (get_option('enable_banner', 'yes') == 'yes') : ?>
                                <li>
                                    <a href="<?= $this->Url->build(['controller' => 'Campaigns', 'action' => 'createBanner', 'prefix' => 'member']); ?>">
                                        <i class='bx bx-radio-circle'></i><?= __('Create Banner Campaign') ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                            <?php if (get_option('enable_popup', 'yes') == 'yes') : ?>
                                <li>
                                    <a href="<?= $this->Url->build(['controller' => 'Campaigns', 'action' => 'createPopup', 'prefix' => 'member']); ?>">
                                        <i class='bx bx-radio-circle'></i><?= __('Create Popup Campaign') ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                        </ul>
                ...
                <?php if (
                    ...
                    <li>
                        <a href="<?= $this->Url->build(['controller' => 'Invoices', 'action' => 'index', 'prefix' => 'member']); ?>">
                ...
                <li class="menu-label"><?= __('Settings') ?></li>

                <li>
                    <a href="javascript:;" class="has-arrow">
                        <div class="parent-icon"><i class='bx bx-cog'></i></div>
                        <div class="menu-title"><?= __('Account Settings') ?></div>
                    </a>
                    <ul>
                        <li>
                            <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'profile', 'prefix' => 'member']); ?>">
                                <i class='bx bx-radio-circle'></i><?= __('Profile') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'changePassword', 'prefix' => 'member']); ?>">
                                <i class='bx bx-radio-circle'></i><?= __('Change Password') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'changeEmail', 'prefix' => 'member']); ?>">
                                <i class='bx bx-radio-circle'></i><?= __('Change Email') ?>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="<?= $this->Url->build(['controller' => 'Forms', 'action' => 'support', 'prefix' => 'member']); ?>">
                ...
                <?php if ((bool)get_option('enable_premium_membership')) : ?>
                    <li>
                        <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'plans', 'prefix' => 'member']); ?>">
                            <div class="parent-icon"><i class='bx bx-diamond'></i></div>
                            <div class="menu-title"><?= __('Change Your Plan') ?></div>
                        </a>
                    </li>
                <?php endif; ?>
            </ul>
        ...
        <footer class="page-footer">
            <p class="mb-0"><?= __('Copyright ©') ?> <?= date("Y") ?>. <?= h(get_option('site_name')) ?></p>
        </footer>
    </div>
    <!--end wrapper-->
