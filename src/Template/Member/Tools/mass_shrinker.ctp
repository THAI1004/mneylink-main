...
<div class="box box-primary">
    <div class="box-body">
        ...
        <p><?= __(
                'Enter up to {0} URLs (one per line) to be shrunk and added to your account',
                get_option('mass_shrinker_limit', 20)
            ) ?></p>
            ...
            <div class="well">
                <?php foreach ($results as $result) : ?>
                    ...
                    <?php if ($result['short'] != 'error'): ?>
                        <p class="text-success" style="font-weight: bold;"><?= get_short_url(
                                                                                $result['short'],
                                                                                $result['domain']
                                                                            ); ?></p>
                    <?php else : ?>
