...
<div class="row gap-4 flex-nowrap mb-4  ">
    <div class="col-sm-4 bg-primary p-2 rounded">
    ...
    <div class="col-sm-4 bg-danger p-2 rounded">
    ...
    <div class="col-sm-4 bg-success p-2 rounded">
